...
```path=apps/base/linkding/namespace.yaml
apiVersion: v1
kind: Namespace
metadata:
  name: linkding
...
```path=apps/staging/linkding/kustomization.yaml
apiVersion: kustomize.config.k8s.io/v1beta1
kind: Kustomization
namespace: linkding
resources:
...
```path=clusters/staging/flux-system/gotk-components.yaml
---
...
```path=clusters/staging/flux-system/gotk-sync.yaml
# This manifest was generated by flux. DO NOT EDIT.
---
...
spec:
  ...
  secretRef:
    name: flux-system
  url: ssh://git@github.com/cshuttle/homelab
---
apiVersion: kustomize.toolkit.fluxcd.io/v1
kind: Kustomization
metadata:
...
```path=clusters/staging/flux-system/kustomization.yaml
apiVersion: kustomize.config.k8s.io/v1beta1
kind: Kustomization
resources:
